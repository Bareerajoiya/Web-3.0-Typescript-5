...
console.log('Sum of Even Numbers is', even_sum);
...
console.log("All Even number", numbers_array);
...
console.log("All odd number", numbers);
...
function largest_number(numbers: string | any[]) {
    var largest = 0;
    for (var index = 0; index < numbers.length; index++) {
